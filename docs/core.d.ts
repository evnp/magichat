export declare function factors(n: number): [number, number];
...
export declare function magicHatStartRepeat(seed: string, seconds: number, handler: (seed: string, question: string) => void): [string, string, number, number];
